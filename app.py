...
# Configuration
CSV_FILE = "restaurants-casvp.csv"
CSV_SEPARATOR = ";"
...
def home():
    ...
    docs = {
        ...
        "endpoints": {
            ...
            "/restaurants/<code_postal>": "Trouve les restaurants par code postal",
            "/restaurants/type/<type>": "Filtre les restaurants par type (E/S)",
            "/search": "Recherche de restaurants (paramètre 'q' pour la recherche)"
        },
        "version": "1.0"
    }
    return jsonify(docs)
...
def get_restaurant_by_code(code_postal):
    """Récupère les restaurants par code postal"""
    data, error = load_data()
...
def get_restaurant_by_type(type):
    """Récupère les restaurants par type (E ou S)"""
    data, error = load_data()
...
def search_restaurants():
    """Recherche de restaurants par nom ou adresse"""
